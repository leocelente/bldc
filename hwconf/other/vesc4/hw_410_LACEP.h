...
#ifndef HW_410_LACEP_H_
#define HW_410_LACEP_H_

#define HW_NAME "410_LACEP"
#define HW_MAJOR 4
#define HW_MINOR 10
 ...
 * ADC Vector
 *
 * 0:	ADC1_IN0		  SENS3       (rank 1)
 * 1:	ADC2_IN1		  SENS2       (rank 1)
 * 2:	ADC3_IN2		  SENS1       (rank 1)
 * 3:	ADC1/2_IN8 		CURR2       (rank 2) or ADC1/2_IN7
 * 4:	ADC1/2_IN9		CURR1       (rank 2) or ADC1/2_IN6
 * 5:	ADC3_IN3		  TEMP_MOSFET (rank 2)
 * 6:	ADC1_Vrefint  -           (rank 3)
 * 7:	ADC2_IN1		  SENS2       (rank 3)
 * 8:	ADC3_IN12	    AN_IN       (rank 3)
 * 9:	ADC1_IN0		  SENS3       (rank 4)
 * 10:ADC2_IN2      SENS1       (rank 4)
 * 11:ADC3_IN10 	  TEMP_MOTOR  (rank 4)
 */
...
/**
 * @brief GET_CURRENTx Macro returns in ADC counts. NOT Volts, the float seems only to be there to confuse.
 * The conversion to amps is in the FAC_CURRENT macro, that is defined in the conf_general.h
 * I tried applying the offset of the voltage reference, but the expected offset in ADC counts of 2048 was 
 * not showing up correctly. I removed the offset calculations on the macro and changed to use
 * the Current Offset configuration on the FOC menu. The offset was showing at around 2030.
 * that cleared the FAULT_CODE_HIGH_OFFSET_CURRENT_SENSOR_x fault.
 */
#define GET_CURRENT1()                                                         \
  ((float)(ADC_Value[ADC_IND_CURR1]))
//  - (CURRENT_V_OFFSET * (4095.0f / V_REG))
#define GET_CURRENT2()                                                         \
  ((float)(ADC_Value[ADC_IND_CURR2]))
//  - (CURRENT_V_OFFSET * (4095.0f / V_REG))
#endif
...
// RS485 RE/DE pins
#define HW_RS485_DE_PORT GPIOC
#define HW_RS485_DE_PIN 1
#define HW_RS485_RE_PORT GPIOC
#define HW_RS485_RE_PIN 3
