...
void hw_init_gpio(void) {
  ...
  palSetPadMode(GPIOC, 5,
                PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_HIGHEST); // LED_RED
  ...
  // palSetPadMode(GPIOA, 4, PAL_MODE_INPUT_ANALOG); // TX_SDA_NSS rerouted as SENS
  // palSetPadMode(GPIOA, 5, PAL_MODE_INPUT_ANALOG); // ADC_EXT  rerouted as SENS
  // palSetPadMode(GPIOA, 6, PAL_MODE_INPUT_ANALOG); // ADC_EXT2 rerouted as SENS
...
void hw_setup_adc_channels(void) {
  ...
  // ADC_TEMP
  ADC_RegularChannelConfig(ADC3, ADC_Channel_3, 2,
                           ADC_SampleTime_15Cycles); // TEMP_MOSFET (ADC_TEMP)
  ADC_RegularChannelConfig(ADC3, ADC_Channel_12, 3,
                           ADC_SampleTime_15Cycles); // AN_IN
  ADC_RegularChannelConfig(ADC3, ADC_Channel_10, 4,
                           ADC_SampleTime_15Cycles); // TEMP_MOTOR
